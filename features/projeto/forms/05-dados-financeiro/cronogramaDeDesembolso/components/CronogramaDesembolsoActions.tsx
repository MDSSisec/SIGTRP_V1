...
type CronogramaDesembolsoActionsProps = {
  isEditing: boolean
  isSaving: boolean
...
/**
 * Ações Editar / Cancelar / Salvar do cronograma de desembolso.
 */
export function CronogramaDesembolsoActions({
  isEditing,
  isSaving,
  saveError,
  canStartEditing,
  ...
  onCancel,
  onSave,
}: CronogramaDesembolsoActionsProps) {
  return (
