...
export const SECOES_COM_REVIEW = [
  ...
  PROJETO_SECOES.dadosGeraisProjeto.slug,
  PROJETO_SECOES.detalhamentoCursos.slug,
  PROJETO_SECOES.despesasEtapa11.slug,
  PROJETO_SECOES.despesasEtapa12.slug,
  PROJETO_SECOES.despesasEventoFinal.slug,
